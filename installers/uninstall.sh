...
rm_docker_containers() {
  ...
  confirm "Removed docker containers and images."
}

rm_wings_files() {
  log "Removing wings files..."
...
rm_database() {
  ...
  alert "Be careful! This database will be deleted!"
  ...
  confirm "Removed database and database user."
}
